...
function MapMarker({
  ...
  const marker = useMemo(() => {
    ...
    const handleDragStart = () => {
      ...
      callbacksRef.current.onDragStart?.({ lng: lngSlat.lng, lat: lngSlat.lat });
    };
    const handleDrag = () => {
      const lngSlat = markerInstance.getLngLat();
      callbacksRef.current.onDrag?.({ lng: lngSlat.lng, lat: lngSlat.lat });
    };
    const handleDragEnd = () => {
      const lngSlat = markerInstance.getLngLat();
      callbacksRef.current.onDragEnd?.({ lng: lngSlat.lng, lat: lngSlat.lat });
    };
